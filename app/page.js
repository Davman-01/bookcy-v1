  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .hero-title { font-family:'Plus Jakarta Sans',sans-serif; font-size: clamp(52px, 8vw, 96px); font-weight:800; color: white; letter-spacing: -4px; line-height: 0.95; margin-bottom:24px; animation: fadeUp 0.8s 0.2s ease both; }
      ...
      <nav>
        ...
        <div className="nav-right">
          ...
          <button onClick={toggleTheme} className="p-2 rounded-full border border-[var(--c-border)] text-[var(--c-text-main)] hover:bg-[var(--c-bg-sub)] transition-colors cursor-pointer mr-2">
                    ...
                    <aside className="w-full lg:w-[320px] theme-bg-card theme-border rounded-[24px] p-6 lg:sticky top-28 shrink-0 shadow-sm flex flex-col gap-8">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="text" placeholder={t[lang].filters.search} value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full theme-bg-sub theme-border-sub rounded-xl py-3 pl-10 pr-4 font-bold text-xs theme-text-main outline-none focus:border-[#E8622A] transition-colors" />
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="relative theme-bg-sub rounded-xl theme-border-sub border">
                                <select value={filterSort} onChange={(e) => setFilterSort(e.target.value)} className="w-full bg-transparent border-none py-3 pl-4 pr-10 font-bold text-xs theme-text-main outline-none appearance-none cursor-pointer">
        ...
        {step === 'shop_profile' && selectedShop && (
            <div className="w-full max-w-6xl mx-auto pt-24 px-4 animate-in fade-in duration-500 pb-20">
                ...
                <div className="w-full h-[250px] md:h-[350px] rounded-[32px] overflow-hidden relative mb-16 theme-border border theme-bg-sub shadow-sm">
                    {selectedShop.cover_url ? <img loading="lazy" decoding="async" src={selectedShop.cover_url} className="w-full h-full object-cover" /> : <div className="w-full h-full bg-gradient-to-r from-[var(--c-border-sub)] to-[var(--c-bg-sub)]"></div>}
                                    ...
                                    <div className="animate-in slide-in-from-right-4 fade-in duration-300 flex-1">
                                        ...
                                        <div className="grid grid-cols-3 gap-3">
                                            <div onClick={() => { setBookingData({...bookingData, selectedStaff: { name: t[lang].book.anyStaff }}); setBookingPhase(3); }} 
                                                 className="flex flex-col items-center gap-2 cursor-pointer p-3 rounded-2xl border-2 border-transparent hover:border-[#E8622A] theme-bg-card shadow-sm hover:shadow-md transition-all">
                                ...
                                {(bookingPhase === 4 || (selectedShop.category === 'Bar & Club' && bookingPhase === 3)) && (
                                    <form onSubmit={handleBooking} className="animate-in slide-in-from-right-4 fade-in duration-300 flex flex-col gap-3 flex-1 mt-auto">
                                        ...
                                        <div className="flex gap-2 w-full">
                                          <input required placeholder={t[lang].book.name} className="w-full theme-bg-sub theme-border rounded-[14px] py-4 px-4 outline-none focus:border-[#E8622A] font-bold text-xs theme-text-main transition-colors" onChange={(e) => setFormData({...formData, name: e.target.value})} />
                                          <input required placeholder={t[lang].book.surname} className="w-full theme-bg-sub theme-border rounded-[14px] py-4 px-4 outline-none focus:border-[#E8622A] font-bold text-xs theme-text-main transition-colors" onChange={(e) => setFormData({...formData, surname: e.target.value})} />
                                        </div>
                                        
                                        <div className="flex gap-2 w-full relative">
                                          <select className="theme-bg-sub theme-border rounded-[14px] py-4 px-3 outline-none focus:border-[#E8622A] font-bold text-xs theme-text-main cursor-pointer w-28 shrink-0" value={formData.phoneCode} onChange={e => setFormData({...formData, phoneCode: e.target.value})}>
                                              <option value="+90">TR (+90)</option>
                                              <option value="+357">CY (+357)</option>
                                              <option value="+44">UK (+44)</option>
                                          </select>
                                          <div className="relative flex-1">
                                              <input required type="tel" placeholder={t[lang].book.phone} className="w-full theme-bg-sub theme-border rounded-[14px] py-4 px-4 pr-10 outline-none focus:border-[#E8622A] font-bold text-xs theme-text-main transition-colors" onChange={handleBookingPhoneChange} />
                                        ...
                                        <div className="relative w-full">
                                            <input required type="email" placeholder={t[lang].book.email} className="w-full theme-bg-sub theme-border rounded-[14px] py-4 px-4 pr-10 outline-none focus:border-[#E8622A] font-bold text-xs theme-text-main transition-colors" onChange={handleBookingEmailChange} />
            ...
            <div className="w-full theme-bg-main animate-in fade-in">
                ...
                <div className="max-w-[1400px] mx-auto px-8 py-24">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        <div className="theme-bg-sub border theme-border-sub rounded-[40px] p-10 md:p-12 shadow-sm relative overflow-hidden">
                            ...
                            <h2 className="text-3xl font-black tracking-tight theme-text-main mb-10 flex items-center gap-4"><Briefcase className="text-[#E8622A]" size={36}/> {t[lang].about.bizTitle}</h2>
                            <div className="space-y-8">
                                <div className="flex gap-5"><div className="w-12 h-12 rounded-full theme-bg-card flex items-center justify-center shadow-sm theme-border shrink-0"><Zap className="text-[#E8622A]" size={20}/></div><div><h3 className="text-lg font-black theme-text-main mb-1">{t[lang].about.biz1}</h3><p className="theme-text-muted font-medium text-sm leading-relaxed">{t[lang].about.biz1Desc}</p></div></div>
                                <div className="flex gap-5"><div className="w-12 h-12 rounded-full theme-bg-card flex items-center justify-center shadow-sm theme-border shrink-0"><Users className="text-[#E8622A]" size={20}/></div><div><h3 className="text-lg font-black theme-text-main mb-1">{t[lang].about.biz2}</h3><p className="theme-text-muted font-medium text-sm leading-relaxed">{t[lang].about.biz2Desc}</p></div></div>
                                <div className="flex gap-5"><div className="w-12 h-12 rounded-full theme-bg-card flex items-center justify-center shadow-sm theme-border shrink-0"><Target className="text-[#E8622A]" size={20}/></div><div><h3 className="text-lg font-black theme-text-main mb-1">{t[lang].about.biz3}</h3><p className="theme-text-muted font-medium text-sm leading-relaxed">{t[lang].about.biz3Desc}</p></div></div>
                                <div className="flex gap-5"><div className="w-12 h-12 rounded-full theme-bg-card flex items-center justify-center shadow-sm theme-border shrink-0"><Crown className="text-[#E8622A]" size={20}/></div><div><h3 className="text-lg font-black theme-text-main mb-1">{t[lang].about.biz4}</h3><p className="theme-text-muted font-medium text-sm leading-relaxed">{t[lang].about.biz4Desc}</p></div></div>
                            </div>
                        </div>
                        ...
                        <div className="theme-bg-card border theme-border rounded-[40px] p-10 md:p-12 shadow-[0_20px_40px_rgba(0,0,0,0.04)] relative overflow-hidden">
                            ...
                            <h2 className="text-3xl font-black tracking-tight theme-text-main mb-10 flex items-center gap-4"><User className="theme-text-main" size={36}/> {t[lang].about.usrTitle}</h2>
                            <div className="space-y-8">
                                <div className="flex gap-5"><div className="w-12 h-12 rounded-full theme-bg-sub flex items-center justify-center shadow-sm border theme-border-sub shrink-0"><Search className="theme-text-main" size={20}/></div><div><h3 className="text-lg font-black theme-text-main mb-1">{t[lang].about.usr1}</h3><p className="theme-text-muted font-medium text-sm leading-relaxed">{t[lang].about.usr1Desc}</p></div></div>
                                <div className="flex gap-5"><div className="w-12 h-12 rounded-full theme-bg-sub flex items-center justify-center shadow-sm border theme-border-sub shrink-0"><Clock className="theme-text-main" size={20}/></div><div><h3 className="text-lg font-black theme-text-main mb-1">{t[lang].about.usr2}</h3><p className="theme-text-muted font-medium text-sm leading-relaxed">{t[lang].about.usr2Desc}</p></div></div>
                                <div className="flex gap-5"><div className="w-12 h-12 rounded-full theme-bg-sub flex items-center justify-center shadow-sm border theme-border-sub shrink-0"><MessageCircle className="theme-text-main" size={20}/></div><div><h3 className="text-lg font-black theme-text-main mb-1">{t[lang].about.usr3}</h3><p className="theme-text-muted font-medium text-sm leading-relaxed">{t[lang].about.usr3Desc}</p></div></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="theme-bg-sub py-24 text-center border-y theme-border-sub">
                    <div className="max-w-[1200px] mx-auto px-8 text-center">
                        <h2 className="text-4xl md:text-5xl font-black tracking-tight theme-text-main mb-4">{t[lang].about.packTitle}</h2>
                        <p className="theme-text-muted font-medium mb-16 max-w-2xl mx-auto text-lg">{t[lang].about.packSub}</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto text-left">
                            <div className="theme-bg-card border theme-border rounded-[40px] p-10 shadow-sm hover:shadow-xl transition-shadow flex flex-col relative overflow-hidden group">
                                ...
                                <h3 className="text-2xl font-black theme-text-main mb-2 uppercase">{t[lang].about.pkg1Name}</h3>
                                <div className="flex items-end gap-2 mb-8 border-b theme-border-sub pb-8"><span className="text-5xl font-black theme-text-main tracking-tighter">{t[lang].about.pkg1Price}</span><span className="theme-text-muted font-bold mb-1">{t[lang].about.pkg1Period}</span></div>
                                <ul className="space-y-4 mb-10 flex-1">
                                    <li className="flex items-center gap-3 theme-text-main font-medium"><Check size={18} className="text-[#00c48c] shrink-0"/> {t[lang].about.pkg1Feat1}</li>
                                    <li className="flex items-center gap-3 theme-text-main font-medium"><Check size={18} className="text-[#00c48c] shrink-0"/> {t[lang].about.pkg1Feat2}</li>
                                    <li className="flex items-center gap-3 theme-text-main font-medium"><Check size={18} className="text-[#00c48c] shrink-0"/> {t[lang].about.pkg1Feat3}</li>
                                    <li className="flex items-center gap-3 theme-text-main font-medium"><Check size={18} className="text-[#00c48c] shrink-0"/> {t[lang].about.pkg1Feat4}</li>
                                    <li className="flex items-center gap-3 theme-text-main font-medium"><Check size={18} className="text-[#00c48c] shrink-0"/> {t[lang].about.pkg1Feat5}</li>
                                </ul>
                                <button onClick={() => {setShowRegister(true); window.scrollTo(0,0);}} className="w-full theme-bg-sub theme-text-main font-black py-4 rounded-xl uppercase tracking-widest hover:border-[#E8622A] theme-border transition-colors cursor-pointer">Seç</button>
                            </div>
